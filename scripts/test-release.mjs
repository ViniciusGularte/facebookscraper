...
async function main() {
  ...
  const steps = [
    ...
    {
      name: "Webhook Signed Events",
      cmd: "npm",
      args: ["run", "test:webhook"],
    ...
    },
    {
      name: "Billing Flow",
      cmd: "npm",
      args: ["run", "test:billing"],
      requires: ["SUPABASE_ANON_KEY", "SUPABASE_SERVICE_ROLE_KEY", "STRIPE_WEBHOOK_SECRET"],
      modes: ["full"],
    },
    {
      name: "Magic Link Lifecycle",
      cmd: "npm",
      args: ["run", "test:magiclink"],
      requires: ["SUPABASE_ANON_KEY", "SUPABASE_SERVICE_ROLE_KEY", "STRIPE_WEBHOOK_SECRET"],
      modes: ["full"],
    },
    {
